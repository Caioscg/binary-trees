...
int checkFila(int adiciona[1000], int remove[1000] , int tamanhoR) {
    int i = 0, contador = 0;
...
int checkPilha(int adiciona[1000], int remove[1000], int tamanhoA , int tamanhoR) {
    int i = 0, contador = 0;
...
int checkFilaPrioridade(int adiciona[1000], int remove[1000], int tamanhoA , int tamanhoR) {
...
int checkIfPossible(int adiciona[1000], int remove[1000], int tamanhoA, int tamanhoR) {
...
int comparaVetores(int adiciona[1000], int remove[1000], int tamanhoA, int tamanhoR) {
    ...
    else if (filaPrioridade==-1 && fila==-1 && pilha==-1) return 4;
    else return 5;
}
